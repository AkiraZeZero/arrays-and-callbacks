...
const newArr = []
const pokemon_name = pokemon.filter(())
 let pokemon_name = pokémon.filter((pokemon_object) => {return pokemon_object == pokemon_object})
...
let only_poison = pokemon.filter( (pokemon_object) => pokemon_object.types[0] === "poison" && pokemon_object.types.length === 1)
